...
check( manual = TRUE, document = FALSE, vignettes = FALSE )
# check( manual = TRUE, document = FALSE, vignettes = TRUE )
...
root_dir = R'(C:\Users\James.Thorson\Desktop\Git\ecostate\scratch)'
